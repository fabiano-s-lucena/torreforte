...
<head>
    ...
    <title>Fathac - Site Control</title>
        ...
        <article class="dash_login_left_box">
            <header class="dash_login_box_headline">
                <div class="dash_login_box_headline_logo  icon-notext">
                    <img src="frontend/assets/images/logo2.png">
            ...
            <footer>
                <p>Desenvolvido por <a href="https://www.fathac.com">www.<b>fathac</b>.com</a></p>
                <p>&copy; <?= date("Y"); ?> - Todos os Direitos Reservados</p>
                <p class="dash_login_left_box_support">
                    <a target="_blank"
                       class="icon-whatsapp transition text-green"
                       href="https://api.whatsapp.com/send?phone=+55+24+993048107&text=Olá, preciso de ajuda com o login."
