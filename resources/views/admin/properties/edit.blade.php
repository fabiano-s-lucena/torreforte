                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="experience" class="select2">
                                        <option value="Em Ilha"
                                            {{ (old('experience') == 'Em Ilha' ? 'selected' : ($property->experience == 'Em Ilha' ? 'selected' : '')) }}>
                                            Em Ilha
                                        </option>
                                        ...
                                        <option value="Comercial"
                                            {{ (old('experience') == 'Comercial' ? 'selected' : ($property->experience == 'Comercial' ? 'selected' : '')) }}>
                                            Comercial
                                        </option>
                                    </select>
                                </label>
