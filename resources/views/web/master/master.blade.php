        ...
        <div class="container">
            <div class="row py-1 d-flex justify-content-md-around">
                ...
                <div class="d-none d-lg-flex col-lg-4 justify-content-center align-items-center p-2 text-white">
                    ...
                    <p class="my-auto ml-3">Rua Carpe Diem, 138 - Portão De Ferro II<br/>Paraty/RJ</p>
                </div>
                ...
                <div class="d-flex col-12 col-md-6 col-lg-4 justify-content-center align-items-center p-2 text-white mx-auto">
                    ...
                    <p class="my-auto ml-3">contato@torfeforteparaty.com.br<br/>(24) 3371-4358 | (24) 9 9955-4044</p>
                </div>
    ...
    <div class="container">
        <div class="row mx-auto" style="max-width: 600px;">
            ...
            <p>Deixe o seu nome e seu melhor e-mail nos campos abaixo e nós vamos lhe informar sobre os melhores
                negócios e todos os lançamentos em Paraty e região</p>
    ...
    <div class="container pt-5" style="padding-bottom: 120px;">
        ...
        <div class="row d-flex justify-content-around text-muted">
            ...
            <div class="col-12 col-md-9 col-lg-6">
                ...
                <p>Nossa maior satisfação é lhe ajudar a encontrar seu imóvel dos sonhos na cidade que é Patrimônio da Humanidade, em Paraty.</p>
...
<div class="main_copyright py-3 bg-front text-white text-center">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="mb-0">Torre Forte Imóveis | CRECI 71751 | Rua Carpe Diem, 138 - Portão De Ferro II - Paraty/RJ</p>
                <p class="mb-0">Todos os Direitos Reservados - Fathac Marketing Digital e Desenvolvimento ®</p>
            </div>
        </div>
    </div>
</div>
